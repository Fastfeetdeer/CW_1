...
## 3. В репозитории оформлено текстовое описание решения (Readme.md)

## 4. Программа, решающая поставленную задачу(Programs.cs) 
...
## 5. В этом репозитории применем контроль версий.